...
/* Simply replace the host, keyname and key with an EH host, keyname and key that have listen access */

#define EH_HOST "EH hostname"
#define EH_KEY_NAME "EH keyname"
#define EH_KEY "EH key"
#define EH_NAME "amqps://" EH_HOST "/ingress/ConsumerGroups/$Default/Partitions/0"
